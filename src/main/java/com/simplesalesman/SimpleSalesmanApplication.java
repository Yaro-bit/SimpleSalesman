 ...
 * handles application startup configuration and logging.
 * 
...
public class SimpleSalesmanApplication {
	...
	/**
	 * Logger instance for this class using SLF4J. Used to log application startup
	 ...
	 * 
	 * This method: 1. Starts the Spring Boot application context 2. Retrieves
	 * environment configuration 3. Logs startup information including app name,
	 * port, and active profiles
	 * 
	 * @param args Command line arguments passed to the application. Common Spring
	 *             Boot arguments include: --server.port=8080 (to change port)
	...
	public static void main(String[] args) {
		...
		// Fallback on 8081, as 8080 used by Keycloak
	...
	/**
	 * Logs system-level information useful for debugging and support. This includes
	 * OS details, Java version, and system properties.
	 */
	...
	/**
	 * Logs runtime and memory information for performance monitoring. Helps
	 * identify potential memory issues during startup.
	 */
	...
	/**
	 * Logs important application configuration properties. Helps with
	...
	/**
	 * Helper method to safely log a property value. Handles cases where properties
	 * might not be set.
	 * 
	...
	private static void logProperty(Environment env, String propertyName, String displayName) {
		...
		if (value != null && !value.trim().isEmpty()) {
			...
			if (propertyName.toLowerCase().contains("password") || propertyName.toLowerCase().contains("secret")
